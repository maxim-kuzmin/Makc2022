...
using Layer2SqlModuleForSqlServerClient = Makc2022.Layer2.Sql.Clients.SqlServer.Setting.ClientSettingModule;
using Layer3SqlModuleForSample = Makc2022.Layer3.Sql.Sample.Setting.SettingModule;
using Layer3SqlModuleForSampleClientSqlServer = Makc2022.Layer3.Sql.Sample.Clients.SqlServer.Setting.ClientSettingModule;
using Layer3SqlModuleForSampleClientSqlServerEF = Makc2022.Layer3.Sql.Sample.Clients.SqlServer.EF.Setting.ClientSettingModule;
using Layer3SqlModuleForSampleMapperEF = Makc2022.Layer3.Sql.Sample.Mappers.EF.Setting.MapperSettingModule;
using IMapperServiceForSample = Makc2022.Layer3.Sql.Sample.Mappers.EF.IMapperService;
using Layer4SqlModuleForDomainDummyMain = Makc2022.Layer4.Sql.Domains.DummyMain.Setting.DomainSettingModule;
using Layer5SqlModuleForServer = Makc2022.Layer5.Sql.Server.Setting.SettingModule;
