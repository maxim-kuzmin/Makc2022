...
export abstract class QueryHandlerImpl implements QueryHandler {
  ...
  constructor(
    ...
    protected readonly queryResource: QueryResource,
  ...
  protected doOnStart(queryCode: string): void {
    ...
    if (Logger.isLevelEnabled('debug') || Logger.isLevelEnabled('verbose')) {
